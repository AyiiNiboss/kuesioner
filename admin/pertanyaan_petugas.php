...
<div class="container">
	...
	<div class="mb-4">
		<h4>Data Pertanyaan Untuk Petugas</h4>
	...
	<div class="row mb-3">
		<div class="col-lg-12">
			...
			<?php } ?>
			<!-- Modal -->
			<form action="petugas_pertanyaan_act.php" method="post">
			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped" id="table-datatable">
					...
					<tbody>
						<?php 
						$no=1;
						$data = mysqli_query($koneksi,"SELECT * FROM pertanyaan_petugas ORDER BY pertanyaan_id ASC");
						while($d = mysqli_fetch_array($data)){
							...
							<tr>
								...
								<td>    
									...
									<form action="pertanyaan_petugas_update.php" method="post">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a href="pertanyaan_petugas_hapus.php?id=<?php echo $d['pertanyaan_id'] ?>" class="btn btn-success btn-sm">Hapus</a>
												</div>
											</div>
										</div>
									</div>
