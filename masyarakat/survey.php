        ...
        <div class="card-body pt-4">
          ...
          if(isset($_GET['alert'])){
            if($_GET['alert'] == "sudah"){
              ...
              echo "<div class='text-center alert alert-danger'><b>MAAF!</b> <br> ANDA HARUS MENGISI SEMUA PERTANYAAN</div>";
            }
          }
          ?>
          ...
          <form action="survey_act.php" method="post">
            ...
            <?php 
            $no = 1;
            $pertanyaan = mysqli_query($koneksi,"SELECT * FROM pertanyaan_dokter");
            while($p = mysqli_fetch_array($pertanyaan)){
              $nox = $no++;
              ?>
              <div class="form-group mb-5" data-pertanyaan-id="<?php echo $p['pertanyaan_id'] ?>">
                <?php echo $nox; ?>.
